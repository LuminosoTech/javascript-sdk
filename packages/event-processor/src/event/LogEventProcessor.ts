...
import { areEventContextsEqual } from "../@types/events";
import { formatEvents } from "./buildEvent";
import { EventQueue } from "../@types/queue";

const logger = getLogger("LogEventProcessor");

export class LogEventProcessor implements EventProcessor {
